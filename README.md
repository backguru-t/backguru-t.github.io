...
- **(주)투라인코드**: 수석 엔지니어, 2020년 1월 ~ 현재 (4년 7개월)
...
- 역할: 개발 계획서, 소프트웨어 아이텍처 및 사용자 요구사항 문서 작성, 소프트웨어 아키텍처 설계 및 통합 플랫폼 서비스 기획, 기존에 C++, C# 등으로 개발되어 상용화되어 있는 모놀리식 소프트웨어 분석 및 주요 문제점 진단 그리고 MSA (Micro Service Architecture) 전환 설계
...
- 역할: Project Leader, 프로젝트 팀 관리, 일정 관리, 개발 계획서, 소프트웨어 아키텍처, 테스트 결과 보고서 등 다수의 프로젝트 관리 문서 작성
...
- 역할: Project Leader, 프로젝트 팀 관리, 일정 관리
...
- 역할: Project Leader, 프로젝트 팀 관리 및 일정 관리
- 언어/프레임워크/플랫폼: 자바 스프링부트
...
- 역할: Project Leader & 수석 엔지니어, 서비스 개발
...
- 역할: Project Leader, 프로젝트 팀 관리, 일정 관리, 프로젝트 관련 문서 작성
- 언어/프레임워크/플랫폼: 자바 스프링부트
